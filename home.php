        ...
        <div class="row-fluid">
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body" >
                        <h4 class="media-heading" >GARDENER</h4>
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading" >COOK</h4>
        ...
        <div class="row-fluid">
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">DRIVER</h4>
            ...
            <div class="span4">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading">MAID  &amp;  BUTLER</h4>
            ...
            <div class="span3" style="margin-left: 50px;">
                ...
                <ul class="unstyled address" style="color: #062F4F">
                    ...
                    <li>
                        ...
                        <strong>Website:</strong>SAJJAD ZAHEER
                    </li>
                    <li>
...
<footer id="footer" style="height: 30px;">
    <div class="container">
        <div class="row-fluid">
            <div class="span5 cp">
                &copy; 2017 <a target="_blank" href="http://www.skilldevelopment.gov.in/pmkvy.html" title="GET YOUR SERVICES">AN INITIATIVE OF SKILL INDIA </a>. All Rights Reserved.
            </div>
            <!--/Copyright-->
